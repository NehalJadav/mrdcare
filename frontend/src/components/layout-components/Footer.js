...
export default function Footer() {
	...
	return (
		...
		`}>
			...
			<div>
				<a className="text-gray" href="https://mrdcare.com/terms/" target="_blank" rel="noopener noreferrer">Term & Conditions</a>
				<span className="mx-2 text-muted"> | </span>
				<a className="text-gray" href="https://mrdcare.com/privacy/" target="_blank" rel="noopener noreferrer">Privacy & Policy</a>
			</div>
		</footer> */}
		</>
	)
